...
<script type="text/javascript">
	...
	location.href="${pageContext.request.contextPath }/product?method=addcart&pid=${product.pid}&buyNum="+buyNum;	
	}
				...
				<div class="col-md-6">
					...
					<div style="padding: 10px; border: 1px solid #e7dbb1; width: 330px; margin: 15px 0 10px 0;; background-color: #fffee6;">
						...
						<div style="border-bottom: 1px solid #faeac7; margin-top: 20px; padding-left: 10px;">		
							购买数量: <input id="buyNum" name="quantity" value="1" maxlength="4" size="10" type="text">
						</div>
					...
					<c:if test="${formpage!='0'}">
							<a href="${pageContext.request.contextPath }/product?method=productList&cid=${cid }&currentPage=${currentPage }">返回上级菜单</a>
						</c:if>	
						<c:if test="${formpage=='0'}">
