			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProduct}" var="hotpro">
					<div class="col-md-2"
						...
						<a href="${pageContext.request.contextPath}/product?method=productInfo&formpage=0&pid=
						${hotpro.pid}"> <img
							src="${pageContext.request.contextPath}/${hotpro.pimage}"
							width="130" height="130" style="display: inline-block;"> </a>
						<p>				
							<a href="${pageContext.request.contextPath}/product?method=productInfo&formpage=0&pid=${hotpro.pid}" style='color:#666'>${hotpro.pname}</a>
						</p>
						<p>
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProduct}" var="newPro">
						<div class="col-md-2"
							style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/product?method=productInfo&formpage=0&pid=
							${hotpro.pid}&formpage=index"> 
							<img src="${pageContext.request.contextPath}/${newPro.pimage}"
								width="130" height="130" style="display: inline-block;"> </a>
							<p>
								<a href="${pageContext.request.contextPath}/product?method=productInfo&formpage=0&pid=
							${hotpro.pid}" style='color:#666'>${newPro.pname}</a>
							</p>
							<p>
