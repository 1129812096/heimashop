...
<body>
		...
		<c:forEach items="${pagebean.list}" var="pro">
			<div class="col-md-2" style="height: 250px">
				<a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${pro.pid}&cid=${cid}&currentPage=${pagebean.currentPage}"> 
					<img src="${pageContext.request.contextPath}/${pro.pimage}" width="170" height="170" style="display: inline-block;"> </a>
				<p>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pagebean.currentPage!=1}">
			<li>
				<a href="${pageContext.request.contextPath}/product?method=productList&cid=${cid}
					&currentPage=${pagebean.currentPage-1}" aria-label="Previous"> 
				<span aria-hidden="true">&laquo;</span>
				</a>
			</li>	
			</c:if>
			<!-- 上一页 -->
				...
				<c:forEach begin="1" end="${pagebean.totalPage}" var="page">
					...
					<c:if test="${page!=pagebean.currentPage}">
						<li>
							<a href="${pageContext.request.contextPath}/product?method=productList&cid=${cid}&currentPage=${page}">
							${page}</a>
						</li>
					</c:if>
				</c:forEach> 
	...
	<div style="width: 1210px; margin: 0 auto; padding: 0 9px; border: 1px solid #ddd; border-top: 2px solid #999; height: 246px;">
		...
		<div style="overflow: hidden;">
			...
			<c:forEach items="${historyProductList }" var="historyPro">
				...
				<img src="${pageContext.request.contextPath}/${historyPro.pimage}" height="130px" />
				${historyPro.pname}
				</li>
			</c:forEach>	
			</ul>
